      ...
      <div className='flex flex-col h-full'>
        ...
        <div className='grid grid-cols-3 gap-4 mt-6 relative'>
          ...
          <div className='col-span-2 bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6'>
            ...
            <FormPedidoDetail items={pedido.items} productos={productos} onEditItem={onEditItem}
            ...
            <div className='flex items-center gap-4'>
              <div className='w-64'>
                <Select id={'condicion_venta_id'} label='Condicion de Venta' options={condicionesVentaOptions}
                        value={pedido?.condicion_venta_id!} onOptionChange={(value) => {
                  setPedido({
                    ...pedido,
              ...
              <div className={'flex-1'}>
                <Input id={'observaciones'} type={'text'} name={'observaciones'} label={'Observaciones'}
                       value={pedido?.observaciones} onChange={(name, value) => {
                  setPedido({
                    ...pedido,
                    [name]: value
                  });
          ...
          <div className='flex gap-4 flex-col'>
            ...
            <InfoAdicionalPedido pedido={pedido} hojasOptions={hojasOptions} tiposOptions={tiposOptions} estadosOptions={estadosOptions} setPedido={setPedido} />
        ...
        {newPedidoId && <PedidoSatisfactorio onClose={() => onConfirmarNuevoPedido()} newPedidoId={newPedidoId} />}
      </div>
    </OuterWrapper>
  );
}
